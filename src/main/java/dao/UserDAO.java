...
//     * @throws SQLException
//     */
//    public User querysUser(User user) throws SQLException {
//        Connection connection = JdbcUtils.getConn();
...
//        preparedStatement.setString(1,user.getName());
//        preparedStatement.setString(2,user.getPassword());
//        if (!"".equals(user.getName()) && user.getName() != null && user.getPassword() != null) {
//            System.out.println("dao/UserDao.sql:"+sql+user.getName()+user.getPassword());
...
//            }
//        } else {
//            System.out.println("dao/userDao.57:user's something is null!");
